...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////		
    	//-------------------------------------------------------------------------   	
    	// przypadek gdy nie ma parametru w linku
    	//-------------------------------------------------------------------------    	
		...
		//$translator->addTranslationFilePattern('translatorzfcuser');
   ...
   /* 	$sessionConfig = new SessionConfig();
    	$sessionConfig->setOptions(array(
    	    ...
    	    'gc_maxlifetime' => 60 * 60 * 24 * 30*3,
    	    'cookie_lifetime' => 60 * 60 * 24 * 30*3,
    	));
    ...
    /*	Zend_Session::setOptions(array(
    	...
    	// konfiguracja sesji z module.config.php
    	//-------------------------------------------------------------------------
        $sessionConfig = new SessionConfig();
    	...
    	//$sessionConfig->setOptions($config['session_manager']); is error if I use global.php
    	//$sessionManager = new SessionManager($sessionConfig);
    	$sessionManager->start();
        $this->sessionContainer = new Container('ContainerNamespace', $sessionManager);
        //die();
        //echo var_dump($this->sessionContainer);
    	/**
    	 * Optional: If you later want to use namespaces, you can already store the
    	 * Manager in the shared (static) Container (=namespace) field
    	 */
    	//Container::setDefaultManager($sessionManager);  // ZMIENILEM!!!!!!!!!!!!!!!!!

    	// gdyby link odnosil sie do konkretnego miejsca to juz bylby jezyk
    	//-------------------------------------------------------------------------
    	...
    	if (!isset($session->locale)) {
    		// ustalenie czy mamy jezyk na liscie
    		//---------------------------------------------------------------------
